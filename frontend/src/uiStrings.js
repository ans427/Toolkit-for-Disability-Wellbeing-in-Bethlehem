  ...
  en: {
    ...
    pages: {
      immediateResources: {
        ...
        ctaAriaLabel: 'Resource page quick actions',
        addResourceButton: 'Submit a Resource',
        addResourceDescription: 'Know a resource to include? Share it with the community.',
        viewMapButton: 'View Accessibility Map',
        viewMapDescription: 'Looking for local support? Browse resources on the Accessibility Map.',
      ...
      resourceDetail: {
        ...
        ctaAriaLabel: 'Resource detail quick actions',
        addResourceButton: 'Submit a Resource',
        addResourceDescription: 'Know a resource to include? Share it with the community.',
        viewMapButton: 'View Accessibility Map',
        viewMapDescription: 'Looking for local support? Browse resources on the Accessibility Map.',
      ...
      accessibilityMap: {
        ...
        backHome: '← Back to Home',
        skipNavAria: 'Skip links for map page',
        skipToQuickActions: 'Skip map and go to add/report actions',
        loading: 'Loading map...',
  ...
  es: {
    ...
    pages: {
      immediateResources: {
        ...
        ctaAriaLabel: 'Acciones rápidas de la página de recursos',
        addResourceButton: 'Enviar un recurso',
        addResourceDescription: '¿Conoces un recurso para incluir? Compártelo con la comunidad.',
        viewMapButton: 'Ver mapa de accesibilidad',
        viewMapDescription: '¿Buscas apoyo local? Explora recursos en el Mapa de Accesibilidad.',
      ...
      resourceDetail: {
        ...
        ctaAriaLabel: 'Acciones rápidas del detalle del recurso',
        addResourceButton: 'Enviar un recurso',
        addResourceDescription: '¿Conoces un recurso para incluir? Compártelo con la comunidad.',
        viewMapButton: 'Ver mapa de accesibilidad',
        viewMapDescription: '¿Buscas apoyo local? Explora recursos en el Mapa de Accesibilidad.',
      ...
      accessibilityMap: {
        ...
        backHome: '← Volver al Inicio',
        skipNavAria: 'Enlaces para saltar en la pagina del mapa',
        skipToQuickActions: 'Saltar el mapa e ir a acciones para agregar o reportar',
